...
from main import EVPNStatusChecker, ConnectError, ConnectAuthError, RpcError
from tests.fixtures.evpn_mock_data import get_mock_xml_response, EXPECTED_RESULTS
...
class TestEVPNStatusChecker:
    ...
    def test_get_evpn_route_status_healthy(self, checker, mock_device):
        ...
        mock_device.rpc.get_evpn_ip_prefix_database_information.return_value = mock_response
    ...
    def test_get_evpn_route_status_rpc_error(self, checker, mock_device):
        ...
        checker.device = mock_device
        mock_device.rpc.get_evpn_ip_prefix_database_information.side_effect = RpcError("RPC failed")
    ...
    def test_get_evpn_route_status_exception(self, checker, mock_device):
        ...
        checker.device = mock_device
        mock_device.rpc.get_evpn_ip_prefix_database_information.side_effect = Exception("Unexpected error")
    ...
    def test_restart_routing_exception(self, checker, mock_device):
        ...
        checker.device = mock_device
        mock_device.rpc.restart_routing_process.side_effect = Exception("Unexpected error")
